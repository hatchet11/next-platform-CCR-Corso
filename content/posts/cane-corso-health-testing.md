---
title: 'What Is DNA Health Testing and Why It Matters for Cane Corso Puppies'
date: '2026-02-15'
description: 'Learn what DNA health testing actually tests for, why AKC breeders perform it, and how it protects both puppies and buyers.'
slug: 'cane-corso-health-testing'
---
...
This does not mean only "clear" dogs should be bred. A dog can carry one copy of a gene variant without being affected (carriers are often perfectly healthy). Smart breeding pairs carriers with tested-clear dogs, which eliminates the risk of producing affected puppies while maintaining genetic diversity.
...
DM is a progressive neurological disease similar to ALS in humans. It is caused by a mutation in the SOD1 gene. Dogs can be DNA tested as clear, carrier, or at-risk. Breeding two carriers or two at-risk dogs produces at-risk puppies. Testing is straightforward and inexpensive — there is no good reason to skip it.
...
When you are evaluating a breeder, ask for documentation — not just assurances. Any reputable breeder should be able to provide:

- OFA registration numbers for hip and elbow evaluations (searchable publicly at ofa.org)
- DNA panel results from an accredited lab (Embark, Paw Print Genetics, UC Davis)
- Cardiac exam date and performing cardiologist's name
- AKC registration numbers for both sire and dam
...
Every CCR Kennels puppy comes with a 2-year health guarantee that covers genetic conditions. This is not just a nice-to-have — it is our commitment that we stand behind our dogs after they leave our home. That guarantee would mean nothing without the testing to back it up.

## The Bottom Line

Health testing costs money and time. Breeders who skip it are cutting corners — either to reduce costs, because they are uninformed, or because they already know their dogs would not pass. When you pay for a health-tested puppy from a responsible breeder, you are not just paying for a dog. You are paying for the years of investment that breeder made in understanding their lines and reducing health risks for your family.

A puppy is a 10–14 year commitment. The extra investment upfront is worth it.
